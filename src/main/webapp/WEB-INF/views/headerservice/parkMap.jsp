...
<!--     클릭한 위치의 위도: 37.64983491918675
클릭한 위치의 경도: 127.68685202366423 -->
    
</head>
<body>
<header class="he3"><%@ include file="../header3.jsp" %></header>
...
window.onload = function() {
	var joongang1 = new kakao.maps.LatLng(37.64983491918675, 127.68685202366423);
	...
	var markerPosition  = new kakao.maps.LatLng(37.64983491918675, 127.68685202366423); 
...
<body >
	<div id="jido1" style="width: 885px; height: 685px;"></div>
</body>
</html>